...
- Controllers: Handle ruby backend code - eg. livekit token generation. 
- Models: Handle all database classes - eg. user
- Views: Handle all HTML and Javascript code.
- Routes: Handle all routes for the application.